...
function handleCellClick(row, col) {
    ...
    if (board[row][col] === 'agua') {
        ...
        cell.innerHTML = '<img src="vecteezy_water-splash-with-sun-shining_23386792.jpg" alt="Água">'; // Imagem de água
        misses++; // Incrementa os erros
    } else if (board[row][col] === 'barco') {
        board[row][col] = 'tiro'; // Marca como tiro
        cell.innerHTML = '<img src="thumb-1920-1339876.png" alt="Barco">'; // Imagem de barco
